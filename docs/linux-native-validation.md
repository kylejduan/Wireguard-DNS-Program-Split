...
baseline `b843960`, and candidate `d0a40ff` against an owned local peer. It uses
...
revisions and use their actual hashes. Admission enforces baseline `b843960` and
